...
def chat_cli():
    print("\nWelcome to the CLI Chatbot for DQN Agent Creation!")
            ...
            if hasattr(response_message, "tool_calls") and response_message.tool_calls:
                for tool_call in response_message.tool_calls:
                    ...
                    if function_name == "DQN_Node_Agent":
                        ...
                        print("Chatbot:", json.dumps(agent_info, indent=4))
            else:
                print("Chatbot:", response_message.content)
        else:
            print("Chatbot: No valid response received.")
